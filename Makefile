...
hw_03: src/main.cpp bin/Huffman.o bin/BinaryFileReader.o  bin/BinaryFileWriter.o  bin/CLI.o  bin/HuffmanArchiver.o  bin/HuffmanNode.o  bin/HuffmanTree.o bin
